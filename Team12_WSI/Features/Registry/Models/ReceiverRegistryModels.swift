...
struct RegistryMockData {
    ...
    static let items: [ReceiverRegistryItem] = [
        ReceiverRegistryItem(name: "Citron Dinner Plates, Set of 4", imagePath: "/img35m.jpg", price: 12000, state: .celebrationPoolAssisted, category: .collections, collection: citronCollection, isPriority: true, description: "Hand-painted citron design."),
        ReceiverRegistryItem(name: "Smeg Espresso Machine", imagePath: "/img71m.jpg", price: 45000, state: .groupGiftActive, category: .groupGifts, groupGift: GroupGift(totalAmountNeeded: 45000, currentContribution: 14000), isPriority: true, description: "Retro style espresso machine."),
